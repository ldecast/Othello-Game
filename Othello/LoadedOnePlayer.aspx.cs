                ...
                switch (color_host)
                {
                    case "Negro":
                        ...
                        try
                        {
                            ...
                            SqlCommand script = new SqlCommand("insert into Partida(tipo,estado,movimientos,jugador1,jugador2,ganador,perdedor,empate) values('solitario','" +
                                    estado + "'," + movimiento_negro.Text + ",'" + jugador_host + "','cpu','" + winner + "','" + loser + "',0)", conexion);
                    ...
                    case "Blanco":
                        ...
                        try
                        {
                            ...
                            conexion.Open();
                            SqlCommand script = new SqlCommand("insert into Partida(tipo,estado,movimientos,jugador1,jugador2,ganador,perdedor,empate) values('solitario','" +
                                    estado + "'," + movimiento_blanco.Text + ",'" + jugador_host + "','cpu','" + winner + "','" + loser + "',0)", conexion);
                            script.ExecuteNonQuery();
                            conexion.Close();
                        }
                        catch (Exception)
                ...
                try
                {
                    ...
                    if (color_host == "Negro")
                    {
                        ...
                        SqlCommand script = new SqlCommand("insert into Partida(tipo,estado,movimientos,jugador1,jugador2,empate) values('solitario','empate'," +
                               movimiento_negro.Text + ",'" + jugador_host + "','cpu',1)", conexion);
                        script.ExecuteNonQuery();
                        conexion.Close();
                    }
                    if (color_host == "Blanco")
                    {
                        ...
                        conexion.Open();
                        SqlCommand script = new SqlCommand("insert into Partida(tipo,estado,movimientos,jugador1,jugador2,empate) values('solitario','empate'," +
                               movimiento_blanco.Text + ",'" + jugador_host + "','cpu',1)", conexion);
                        script.ExecuteNonQuery();
                        conexion.Close();
                    }
                }
