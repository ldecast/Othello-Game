<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OthelloDinamico.aspx.cs" Inherits="Othello.OthelloDinamico" %>
...
<title>Othello game</title>
  ...
  <style>body{background-color: #2e86c1;} #guardar{margin-top: 52px; width:170px; height:50px;} #salir{ margin-top: 20px; margin-bottom:20px; width:170px; height:50px;} #iniciar{margin-left: 520px; margin-bottom: 30px; width:115px;} #ceder_turno{position:absolute; top:59px; right:60px;}
      .tablero { position:absolute; right: 500px; } .panel{ position:absolute; left: 50px; } .letras{ width:50px; text-align:center;} .none{width:40px;}
  </style>
  </head>
  <body>
  <form id="tablero" runat="server">
    <div class="container-fluid">
        ...
        <div class="container">
            <asp:Button runat="server" id="iniciar" CssClass="text-center btn btn-warning btn-lg" Text="INICIAR" Visible="false" OnClick="Crear_tablero"/>
            <div class="row mb-5">
                <div class="col-sm-12 col-lg-2 pr-5 mt-5 text-right panel border-left border-dark">
                    ...
                    <asp:Label runat="server" id="movimiento_user" CssClass="display-4 text" text="0" />
                    <asp:Label runat="server" id="movimiento_oponente" CssClass="display-4 text-white" text="0" Visible="false"  />
                    <br /><br /><br /><br />
                    <h3>SCORE</h3><hr><br>
                    ...
                    <asp:Button runat="server" type="button" id="salir" CssClass="btn btn-outline-dark btn-lg" text="Terminar juego" OnClick="Ver_botones"/>
                </div>


                <asp:Panel runat="server" id="resultados" Cssclass="col-sm-12 col-lg-10 tablero text-center" Visible="false">
                    <br /><br />
                    <asp:Label runat="server" id ="gameover" CssClass="display-1" Text="GAME OVER"/><br />
                    <asp:Label runat="server" CssClass="display-1" id="ganador"/>
                </asp:Panel>
                ...
                <asp:Panel runat="server" id="gameBoard">
                    ...
                    <asp:Panel runat="server" ID="fila11" class="btn-group">
                        ...
                        <asp:Button runat="server" type="button" id="j11" Visible="false" CssClass="btn btn-dark btn-lg border-dark rounded-0" text="     " OnClick="J11_Click"/>
                        <asp:Button runat="server" type="button" id="k11" Visible="false" CssClass="btn btn-light btn-lg border-dark rounded-0" text="     " OnClick="K11_Click"/>
                     ...
                     <asp:Panel runat="server" ID="fila12" class="btn-group">
                        ...
                        <asp:Button runat="server" type="button" id="j12" Visible="false" CssClass="btn btn-light btn-lg border-dark rounded-0" text="     " OnClick="J12_Click"/>
                        <asp:Button runat="server" type="button" id="k12" Visible="false" CssClass="btn btn-dark btn-lg border-dark rounded-0" text="     " OnClick="K12_Click"/>
