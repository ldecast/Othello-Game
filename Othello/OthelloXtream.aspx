...
<style>body{background-color: #2e86c1;} #guardar{margin-top: 52px; width:170px; height:50px;} #cronometro{position:absolute; top:65px; left:85px;} #salir{margin-top: 20px; margin-bottom:20px; width:170px; height:50px;} #end{margin-top: 20px; margin-bottom:20px; width:170px; height:50px;} #iniciar{margin-left: 520px; margin-bottom: 30px; width:115px;} #ceder_turno{position:absolute; top:55px; right:55px; width:auto;} .aux{position:absolute; top:0px; left:0px;} .aux2{position:absolute; top:0px; right:0px;} .aux3{position:absolute; top:0px; right:400px; color: #2e86c1;} .aux4{position:absolute; top:0px; right:300px; color: #2e86c1;} .aux5{position:absolute; top:0px; right:750px; color: #2e86c1;}
.btn-Rojo{ background-color: #c72b2b !important; width:50px; height:50px } .btn-Amarillo{ background-color: #e0bf07 !important; width:50px; height:50px } .btn-Azul{ background-color: #203ee9 !important; width:50px; height:50px } .btn-Naranja{ background-color: #f2751c !important; width:50px; height:50px } .btn-Verde{ background-color: #00ff22 !important; width:50px; height:50px } .btn-Violeta{ background-color: #951ec8 !important; width:50px; height:50px } .btn-Celeste{ background-color: #1d90e4 !important; width:50px; height:50px } .btn-Gris{ background-color: gray !important; width:50px; height:50px } .btn-Negro{ background-color: black !important; width:50px; height:50px } .btn-Blanco{ background-color: ghostwhite !important; width:50px; height:50px } .aux6{position:absolute; top:0px; right:850px; color: #2e86c1;}
.tablero { position:absolute; right: 480px; } .panel{ position:absolute; left: 50px; } .letras{ width:50px; text-align:center;} .none{width:40px;} .resultados{ position:absolute; top:210px; left:250px;} .time{position:absolute; top:65px; left:85px;} .btn-lg{ width:55px; height:52px; } .vacio{ width:46px; } .numero{ width:75px; }
</style>
